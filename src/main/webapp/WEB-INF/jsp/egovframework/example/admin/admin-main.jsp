...
<div class="row">
	<div class="col-lg-12">
		<h3 class="page-header">
			<i class="fa fa-laptop"></i> Dashboard(여기는 그냥 메인 화면입니다. 기능없어요.)
		</h3>
		<ol class="breadcrumb">
					...
					<ul class="chats">
						...
						<li class="by-me">
							...
							<div class="chat-content">
								...
								Vivamus diam elit diam, consectetur fermentum sed dapibus eget,
								Vivamus consectetur dapibus adipiscing elit.
								<div class="clearfix"></div>
							</div>
						</li>
